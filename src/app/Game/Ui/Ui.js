...
class Ui extends EventEmitter {
  constructor() {
    ...
    this.options.showGround =
      this.options.showGround === undefined ? true : !!this.options.showGround;
  ...
  teleportToWorldPosition(screenX, screenY) {
    ...
    if (this.components.PopupOverlay) {
      this.components.PopupOverlay.showHint(
      ...
      for (var buildingId in this.buildingSchema) {
        if (buildingId == entityData.Name) {
          ...
          if (entityData.TowerRadius) {
            ...
            this.buildingSchema[buildingId].rangeTiers =
              entityData.HarvestRange;
          }
