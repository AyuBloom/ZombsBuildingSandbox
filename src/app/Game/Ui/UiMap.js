...
class UiMap extends _UiComponent {
  constructor(ui) {
    ...
    this.teleportTooltip = this.ui.createElement(
      '<div class="hud-tooltip hud-tooltip-top hud-map-teleport-tooltip"><h4>Teleport</h4><h5>Click to Teleport</h5></div>',
    );
  ...
  onMouseMove(event) {
    ...
    this.teleportTooltip.innerHTML =
      "<h4>Teleport</h4><h5>X: " + targetX + ", Y: " + targetY + "</h5>";
  }
