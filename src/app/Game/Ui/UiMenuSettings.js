...
class UiMenuSettings extends _UiComponent {
  constructor(ui) {
    ...
    this.obstacleIndicatorsElem = this.componentElem.querySelector(
      ".hud-settings-obstacle-indicators",
    );
    this.resourceCollisionsElem = this.componentElem.querySelector(
      ".hud-settings-resource-collisions",
    );
    this.groupingGridElem = this.componentElem.querySelector(
      ".hud-settings-grouping-grid",
    );
    this.showGroundElem = this.componentElem.querySelector(
      ".hud-settings-show-ground",
    );
    ...
    this.obstacleIndicatorsElem.addEventListener(
      "change",
      this.onObstacleIndicatorsChange.bind(this),
    );
    this.resourceCollisionsElem.addEventListener(
      "change",
      this.onResourceCollisionsChange.bind(this),
    );
    this.groupingGridElem.addEventListener(
      "change",
      this.onGroupingGridChange.bind(this),
    );
    this.showGroundElem.addEventListener(
      "change",
      this.onShowGroundChange.bind(this),
    );
  }
  show() {
    this.obstacleIndicatorsElem.checked =
      !!this.ui.getOption("obstacleIndicators");
    this.resourceCollisionsElem.checked = !!this.ui.getOption(
      "showResourceCollisions",
    );
