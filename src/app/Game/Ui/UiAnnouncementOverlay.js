...
class UiAnnouncementOverlay extends _UiComponent {
  constructor(ui) {
    super(
      ui,
      '<div id="hud-announcement-overlay" class="hud-announcement-overlay"></div>',
    );
  }
  showAnnouncement(message) {
    debug("Displaying announcement: %s", message);
    var announcementElem = this.ui.createElement(
      '<div class="hud-announcement-message">' + message + "</div>",
    );
