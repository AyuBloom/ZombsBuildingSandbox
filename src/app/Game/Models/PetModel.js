...
class PetModel extends _CharacterModel {
    ...
    updateModel(tick, networkEntity) {
        ...
        if (tick.model.indexOf("PetCARL") > -1) {
            this.base = new _SpriteEntity("/asset/image/entity/pet-carl/pet-carl-t" + tick.tier + "-base.svg");
            this.weapon = new _SpriteEntity("/asset/image/entity/pet-carl/pet-carl-t" + tick.tier + "-weapon.svg");
            ...
            this.base = new _SpriteEntity("/asset/image/entity/pet-miner/pet-miner-t" + tick.tier + "-base.svg");
            this.weapon = new _SpriteEntity("/asset/image/entity/pet-miner/pet-miner-t" + tick.tier + "-weapon.svg");
            this.weapon.setAnchor(0.5, 1);
            this.weaponUpdateFunc = this.updateSwingingWeapon(300, 100);
        }
