...
class RangedZombieModel extends _CharacterModel {
    ...
    updateModel(tick, networkEntity) {
        ...
        this.base = new _SpriteEntity("/asset/image/entity/zombie-ranged-green/zombie-ranged-green-t" + tier + "-base.svg");
        this.weapon = new _SpriteEntity("/asset/image/entity/zombie-ranged-green/zombie-ranged-green-t" + tier + "-bow.svg");
        var bowHands = new _SpriteEntity("/asset/image/entity/zombie-ranged-green/zombie-ranged-green-t" + tier + "-bow-hands.svg");
