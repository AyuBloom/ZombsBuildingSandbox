...
class PlayerModel extends _CharacterModel {
    constructor() {
        super();
        this.base = new _SpriteEntity("/asset/image/entity/pet-ghost/pet-ghost-t1-base.svg");
    ...
    update(dt, user) {
        ...
        if (tick) {
            ...
            const aimingYaw = _Util.interpolateYaw(networkEntity.getTargetTick().aimingYaw, networkEntity.getFromTick().aimingYaw);
