...
class GoldMineModel extends _ModelEntity {
    constructor() {
        ...
        this.base = new _SpriteEntity("/asset/image/entity/gold-mine/gold-mine-t1-base.svg");
        this.head = new _SpriteEntity("/asset/image/entity/gold-mine/gold-mine-t1-head.svg");
    ...
    updateModel(tick, networkEntity) {
        if (tick.tier != this.currentTier) {
            ...
            switch (this.currentTier) {
                ...
                case 7:
                case 8:
                    this.base = new _SpriteEntity("/asset/image/entity/gold-mine/gold-mine-t" + this.currentTier + "-base.svg");
                    this.head = new _SpriteEntity("/asset/image/entity/gold-mine/gold-mine-t" + this.currentTier + "-head.svg");
                    break;
                default:
