      ...
      switch (this.currentTier) {
        ...
        case 8:
          this.base = new _SpriteEntity(
            "/asset/image/entity/harvester/harvester-t" +
              this.currentTier +
              "-base.svg",
          );
          ...
          this.pivotPointFar.drawCircle(
            0,
            0,
            8,
            _Util.hexToRgb(this.colorMapping[this.currentTier].pivot),
            {
              r: 51,
              g: 51,
              b: 51,
          ...
          this.armFar.drawRoundedRect(
            0,
            0,
            16,
            24,
            8,
            _Util.hexToRgb(this.colorMapping[this.currentTier].arm),
            {
              r: 51,
              g: 51,
              b: 51,
          ...
          this.pivotPointClose.drawCircle(
            0,
            0,
            10,
            _Util.hexToRgb(this.colorMapping[this.currentTier].pivot),
          ...
          this.pivotPointHead.drawCircle(
            0,
            0,
            10,
            _Util.hexToRgb(this.colorMapping[this.currentTier].pivot),
        ...
        default:
          throw new Error(
            "Unknown tier encountered for harvester: " + this.currentTier,
          );
      }
