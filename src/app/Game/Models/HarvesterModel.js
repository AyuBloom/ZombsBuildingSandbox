...
class HarvesterModel extends _ModelEntity {
    constructor() {
        super();
    ...
    updateModel(tier) {
        if (tier != this.currentTier) {
            ...
            switch (this.currentTier) {
                ...
                case 7:
                case 8:
                    this.base = new _SpriteEntity("/asset/image/entity/harvester/harvester-t" + this.currentTier + "-base.svg");
                    this.head = new _SpriteEntity("/asset/image/entity/harvester/harvester-t" + this.currentTier + "-head.svg");
                    this.head.setPivotPoint(10, 0);
                    this.claw = new _SpriteEntity("/asset/image/entity/harvester/harvester-t" + this.currentTier + "-claw.svg");
                    this.claw.setPivotPoint(0, this.claw.getNode().height / 2);
                    this.pivotPointFar = new _DrawEntity();
                    this.pivotPointFar.drawCircle(0, 0, 8, _Util.hexToRgb(this.colorMapping[this.currentTier].pivot), {
                        r: 51,
                        g: 51,
                        b: 51
                    }, 5);
                    ...
                    this.armFar = new _DrawEntity();
                    this.armFar.drawRoundedRect(0, 0, 16, 24, 8, _Util.hexToRgb(this.colorMapping[this.currentTier].arm), {
                        r: 51,
                        g: 51,
                        b: 51
                    }, 5);
                    ...
                    this.pivotPointClose = new _DrawEntity();
                    this.pivotPointClose.drawCircle(0, 0, 10, _Util.hexToRgb(this.colorMapping[this.currentTier].pivot), {
                        r: 51,
                        g: 51,
                        b: 51
                    }, 5);
                    ...
                    this.armClose = new _DrawEntity();
                    this.armClose.drawRoundedRect(0, 0, 16, 40, 8, _Util.hexToRgb(this.colorMapping[this.currentTier].arm), {
                        r: 51,
                        g: 51,
                        b: 51
                    }, 5);
                    ...
                    this.pivotPointHead = new _DrawEntity();
                    this.pivotPointHead.drawCircle(0, 0, 10, _Util.hexToRgb(this.colorMapping[this.currentTier].pivot), {
                        r: 51,
                        g: 51,
                        b: 51
                    }, 5);
    ...
    updateAnimation(tick) {
        if (tick.firingTick) {
            ...
            var animationPercent = Math.min(msSinceFiring / animationDuration, 1);
    ...
    updateStatusBars(tick) {
        ...
        this.barBackgrounds.drawRoundedRect(4, 8, 40, 18, 2, {
            r: 0,
            g: 0,
            b: 0
        });
        this.barBackgrounds.drawRoundedRect(4, 22, 40, 32, 2, {
            r: 0,
            g: 0,
            b: 0
        });
        this.fillBar.clear();
        if (fillRatio > 0) {
            this.fillBar.drawRoundedRect(4, 8, 4 + fillRatio * 36, 18, 2, {
                r: 255,
                g: 184,
                b: 0
            });
        ...
        this.fuelBar.clear();
        if (fuelRatio > 0) {
            this.fuelBar.drawRoundedRect(4, 22, 4 + fuelRatio * 36, 32, 2, {
                r: 255,
                g: 88,
                b: 23
            });
