...
class SlowTrapModel extends _ModelEntity {
    constructor() {
        super();
        this.currentTier = 1;
        this.base = new _SpriteEntity("/asset/image/entity/slow-trap/slow-trap-t1-base.svg");
    ...
    updateModel(tick, networkEntity) {
        if (tick.tier != this.currentTier) {
            ...
            switch (this.currentTier) {
                ...
                case 7:
                case 8:
                    this.base = new _SpriteEntity("/asset/image/entity/slow-trap/slow-trap-t" + this.currentTier + "-base.svg");
                    break;
                default:
