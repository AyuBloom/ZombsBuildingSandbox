...
class NeutralModel extends _CharacterModel {
    ...
    updateModel(tick, networkEntity) {
        ...
        this.base = new _SpriteEntity("/asset/image/entity/neutral/neutral-t" + tier + "-base.svg");
        this.weapon = new _SpriteEntity("/asset/image/entity/neutral/neutral-t" + tier + "-weapon.svg");
