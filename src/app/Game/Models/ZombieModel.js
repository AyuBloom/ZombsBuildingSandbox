  ...
  updateModel(tick, networkEntity) {
    if (tick.model.indexOf("ZombieGreen") > -1) {
      ...
      this.base = new _SpriteEntity(
        "/asset/image/entity/zombie-green/zombie-green-t" + tier + "-base.svg",
      );
      this.weapon = new _SpriteEntity(
        "/asset/image/entity/zombie-green/zombie-green-t" +
          tier +
          "-weapon.svg",
      );
      ...
      this.base = new _SpriteEntity(
        "/asset/image/entity/zombie-blue/zombie-blue-t" + tier + "-base.svg",
      );
      this.weapon = new _SpriteEntity(
        "/asset/image/entity/zombie-blue/zombie-blue-t" + tier + "-weapon.svg",
      );
      this.weapon.setAnchor(0.5, 1);
      if (tier === 1) {
        this.weaponUpdateFunc = this.updatePunchingWeapon();
      ...
      this.base = new _SpriteEntity(
        "/asset/image/entity/zombie-red/zombie-red-t" + tier + "-base.svg",
      );
      this.weapon = new _SpriteEntity(
        "/asset/image/entity/zombie-red/zombie-red-t" + tier + "-weapon.svg",
      );
      this.weapon.setAnchor(0.5, 1);
      if (tier === 1) {
        this.weaponUpdateFunc = this.updatePunchingWeapon();
      ...
      this.base = new _SpriteEntity(
        "/asset/image/entity/zombie-yellow/zombie-yellow-t" +
          tier +
          "-base.svg",
      );
      this.weapon = new _SpriteEntity(
      ...
      this.base = new _SpriteEntity(
        "/asset/image/entity/zombie-purple/zombie-purple-t" +
          tier +
          "-base.svg",
      );
      this.weapon = new _SpriteEntity(
      ...
      this.base = new _SpriteEntity(
        "/asset/image/entity/zombie-orange/zombie-orange-t" +
          tier +
          "-base.svg",
      );
      this.weapon = new _SpriteEntity(
