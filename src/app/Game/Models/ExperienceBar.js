...
class ExperienceBar extends _Entity {
    constructor() {
        super();
        this.barColor = {
            r: 214,
        ...
        this.backgroundNode.drawRoundedRect(this.offset, 0, this.width, this.height, 3, {
            r: 0,
            g: 0,
            b: 0
        });
        this.backgroundNode.drawCircle(6, -4, 12, {
            r: 0,
            g: 0,
            b: 0
        });
        ...
        this.levelEntity = new _TextEntity(this.level.toString(), "Open Sans", 12);
    ...
    setSize(width, height) {
        ...
        this.backgroundNode.drawCircle(6, -3, 12, {
            r: 0,
            g: 0,
            b: 0
        });
