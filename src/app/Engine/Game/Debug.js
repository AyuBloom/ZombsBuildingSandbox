...
class Debug {
  ...
  init() {
    var debugHtml =
      '<div id="hud-debug" class="hud-debug" style="position:fixed;top:112px;left:20px;color:#ff0000;font-family:sans-serif;"></div>';
  ...
  onRendererTick() {
    ...
    if (this.visible && this.ticks % 20 === 0) {
      ...
      var realClientTime = _Game.currentGame.world
        .getReplicator()
        .getRealClientTime();
      var frameStutters = _Game.currentGame.world
        .getReplicator()
        .getFrameStutters();
      ...
      var framesExtrapolated =
        _Game.currentGame.metrics.getFramesExtrapolated();
      var clientTimeResets = _Game.currentGame.world
        .getReplicator()
        .getClientTimeResets();
      ...
      for (var modelEntityName in _Game.currentGame.getModelEntityPooling()) {
        text =
          ...
          modelEntityName +
          ": " +
          _Game.currentGame.world.getPooledModelEntityCount(modelEntityName) +
          "<br>";
      }
