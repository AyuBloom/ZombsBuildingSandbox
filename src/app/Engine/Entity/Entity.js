...
class Entity {
    ...
    isInViewport() {
        ...
        return !(this.node.position.x - this.node.width > currentViewport.x + currentViewport.width) && !(this.node.position.y - this.node.height > currentViewport.y + currentViewport.height) && !(this.node.position.x + this.node.width < currentViewport.x) && !(this.node.position.y + this.node.height < currentViewport.y);
    }
    update(dt, user) {
        if (this.shouldCull) {
