...
class EntityGrid {
    ...
    getEntitiesInCell(index) {
        return index in this.cellEntities && this.cellEntities[index];
    }
    updateEntity(entity) {
        ...
        var isDirty = this.entityMap[entity.uid].length !== cellIndexes.length || !this.entityMap[entity.uid].every((element, i) => {
